...
<h1 style="font-size:28px;font-weight:800;color:#0057ff;margin:0;">Q10 Courses</h1>
</div>
...
<a href="${frontendUrl}/login" style="display:inline-block;background:#0057ff;color:#fff;text-decoration:none;padding:14px 32px;border-radius:12px;font-weight:600;font-size:16px;margin-top:16px;">Iniciar Sesión</a>
...
<p style="color:#525252;font-size:12px;text-align:center;margin-top:32px;">© 2026 Q10 Courses</p>
  ...
  async sendQ10CredentialsEmail(email: string, name: string, q10User: string, q10Pass: string, courses: { title: string; link: string | null }[]) {
    const courseList = courses.map(c =>
      `<p style="margin:4px 0;color:#a0a0a0;">📚 ${c.title} — ${c.link ? `<a href="${c.link}" style="color:#0057ff;">Ir al curso</a>` : '<span style="color:#525252;">Sin enlace</span>'}</p>`
    ).join('');
      ...
      <body style="font-family: 'Inter', Arial, sans-serif; background: #0a0a0a; color: #fafafa; margin: 0; padding: 0;">
        <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
          ...
          <div style="background: #1a1a1a; border-radius: 16px; padding: 40px; border: 1px solid #2a2a2a;">
            ...
            <a href="${this.configService.get('FRONTEND_URL')}/courses" style="display: inline-block; background: #0057ff; color: #fff; text-decoration: none; padding: 14px 32px; border-radius: 12px; font-weight: 600; font-size: 16px; margin-top: 16px;">Explorar Cursos</a>
          </div>
      ...
      <body style="font-family: 'Inter', Arial, sans-serif; background: #0a0a0a; color: #fafafa; margin: 0; padding: 0;">
        <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
          ...
          <div style="background: #1a1a1a; border-radius: 16px; padding: 40px; border: 1px solid #2a2a2a;">
            ...
            ${courseLink ? `<a href="${courseLink}" style="display: inline-block; background: #0057ff; color: #fff; text-decoration: none; padding: 14px 32px; border-radius: 12px; font-weight: 600; font-size: 16px; margin-top: 16px;">Ir al Curso</a>` : ''}
          </div>
          <p style="color: #525252; font-size: 12px; text-align: center; margin-top: 32px;">© 2026 Q10 Courses</p>
        </div>
      </body>
      ...
      <body style="font-family: 'Inter', Arial, sans-serif; background: #0a0a0a; color: #fafafa; margin: 0; padding: 0;">
        <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
          <div style="background: #1a1a1a; border-radius: 16px; padding: 40px; border: 1px solid #2a2a2a;">
            ...
            <a href="${resetUrl}" style="display: inline-block; background: #0057ff; color: #fff; text-decoration: none; padding: 14px 32px; border-radius: 12px; font-weight: 600; font-size: 16px; margin-top: 16px;">Restablecer Contraseña</a>
      ...
      <body style="font-family: 'Inter', Arial, sans-serif; background: #0a0a0a; color: #fafafa; margin: 0; padding: 0;">
        <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
          <div style="background: #1a1a1a; border-radius: 16px; padding: 40px; border: 1px solid #2a2a2a;">
            ...
            <a href="${courseLink}" style="display: inline-block; background: #0057ff; color: #fff; text-decoration: none; padding: 14px 32px; border-radius: 12px; font-weight: 600; font-size: 16px; margin-top: 16px;">Acceder al Curso</a>
          </div>
        </div>
      </body>
      </html>
